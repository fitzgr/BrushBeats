export const ROADMAP_TITLE = "Brush Beats Development Roadmap";
...
export const ROADMAP_UI_TITLE = "Brush Beats IndexedDB, Household, and Gamification Roadmap";

export const ROADMAP_UI_DESCRIPTION =
  "This roadmap sequences the move from cookie-based local storage to a durable IndexedDB architecture that supports households, long-term history, gamification, and future cloud sync without overcomplicating the MVP.";
...
export function getRoadmapData() {
  return {
    ...
    infrastructureItems: INFRASTRUCTURE_ITEMS,
    futureIdeas: FUTURE_IDEAS
  };
}
